                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        {user ? (
                            <div className="flex items-center gap-4">
                                ...
                                <button onClick={handleSignOut} className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
                                    Sign Out
                                </button>
                            </div>
                        ) : (
                    ...
                    >
                        <div className="px-4 pt-2 pb-6 space-y-2">
                            {navLinks.map((link) => (
                             ...
                             {user ? (
                                <button onClick={handleSignOut} className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800">
                                    Sign Out
                                </button>
                            ) : (
