    ...
    <div className="max-w-4xl mx-auto space-y-12">
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
          Our advanced machine learning model analyzes email patterns to detect
          threats that traditional filters miss.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="card space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            Trained on over 50,000 confirmed phishing emails and legitimate
            correspondence. Our dataset is continuously updated with the latest
        ...
        <div className="card space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            Utilizes a hybrid approach combining Naive Bayes, TF-IDF
            Vectorization, and heuristic rule-based detection to identify
            suspicious URLs, urgency triggers, and spoofed domains.
          </p>
        </div>
      </div>
      ...
      <div className="bg-slate-900 dark:bg-slate-800 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto">
            Your data is processed locally in memory and never stored without
            your explicit permission. We adhere to the strictest data privacy
            standards.
          </p>
          <div className="flex justify-center gap-4 pt-4">
            ...
            <button
              className="btn-primary px-4 py-1 text-xs ml-4"
