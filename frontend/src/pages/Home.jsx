    ...
    try {
      ...
      setError(
        err.response?.data?.error ||
          "Failed to analyze input. Please try again.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="space-y-16">
      <div className="text-center space-y-6 max-w-3xl mx-auto">
        ...
        >
          Paste any email content below. Our enterprise-grade AI scans for
          phishing patterns, malicious links, and social engineering tactics in
          milliseconds.
        </motion.p>
      </div>
